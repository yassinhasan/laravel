            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form method="POST" action="{{route("register")}}">
                    ...
                    <div class="form-outline mb-4">
                        <input type="name" id="formname" class="form-control form-control-lg" name="name"
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="form-check mb-0">
                            <input class="form-check-input me-2" type="checkbox"  id="form2Example3" name="rememer"/>
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2">
                        <button type="submit" class="btn btn-primary btn-lg" name="save"
